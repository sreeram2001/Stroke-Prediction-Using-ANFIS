from pyit2fls import IT2FS,tri_mf,gaussian_mf, IT2FS_Gaussian_UncertMean, \
    IT2FS_plot, IT2FLS, min_t_norm, max_s_norm, TR_plot, crisp
from numpy import linspace

class fis:
 def calculate_FLS(self,heart_disease,Age,bmi,avg_glucose_level):
    ...
    def plot_risk_mf():
         IT2FS_plot(risk_low,risk_belownormal,risk_normal,risk_abovenormal,risk_high,
                   title="Risklevel",
                   legends=["risk_low","risk_belownormal","risk_normal","risk_abovenormal","risk_high"],
                   )
   # plot_hd_mf()
    #plot_age_mf()
    #plot_bmi_mf()
    ...
    return print( int((crisp(tr["risk"]))*10) )
if __name__=="__main__":
     f=fis()    
     f.calculate_FLS(1,50,35,270)
